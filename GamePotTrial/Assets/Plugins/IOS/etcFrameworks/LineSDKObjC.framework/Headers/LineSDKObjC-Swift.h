...
typedef SWIFT_ENUM(NSInteger, LineSDKFlexBubbleContainerDirection, closed) {
...
typedef SWIFT_ENUM(NSInteger, LineSDKFlexButtonComponentStyle, closed) {
...
typedef SWIFT_ENUM(NSInteger, LineSDKFlexMessageComponentAlignment, closed) {
...
typedef SWIFT_ENUM(NSInteger, LineSDKFlexMessageComponentAspectMode, closed) {
...
typedef SWIFT_ENUM(NSInteger, LineSDKFlexMessageComponentAspectRatio, closed) {
...
typedef SWIFT_ENUM(NSInteger, LineSDKFlexMessageComponentGravity, closed) {
...
typedef SWIFT_ENUM(NSInteger, LineSDKFlexMessageComponentHeight, closed) {
  LineSDKFlexMessageComponentHeightNone = 0,
  LineSDKFlexMessageComponentHeightSm = 1,
  LineSDKFlexMessageComponentHeightMd = 2,
};

typedef SWIFT_ENUM(NSInteger, LineSDKFlexMessageComponentLayout, closed) {
...
typedef SWIFT_ENUM(NSInteger, LineSDKFlexMessageComponentMargin, closed) {
...
typedef SWIFT_ENUM(NSInteger, LineSDKFlexMessageComponentSize, closed) {
...
typedef SWIFT_ENUM(NSInteger, LineSDKFlexMessageComponentSpacing, closed) {
...
typedef SWIFT_ENUM(NSInteger, LineSDKFlexMessageComponentWeight, closed) {
...
typedef SWIFT_ENUM(NSInteger, LineSDKGetFriendsRequestSort, closed) {
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)login;
@property (nonatomic, copy) NSArray<LineSDKLoginManagerOptions *> * _Nullable loginManagerOptions SWIFT_DEPRECATED_MSG("Use `loginManagerParameters` instead.");
@end

typedef SWIFT_ENUM(NSInteger, LineSDKLoginButtonSize, closed) {
...
SWIFT_CLASS("_TtC11LineSDKObjC38LineSDKMessageShareAuthorizationStatus")
@interface LineSDKMessageShareAuthorizationStatus : NSObject
@property (nonatomic, readonly) NSInteger rawValue;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) LineSDKMessageShareAuthorizationStatus * _Nonnull authorized;)
+ (LineSDKMessageShareAuthorizationStatus * _Nonnull)authorized SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) LineSDKMessageShareAuthorizationStatus * _Nonnull lackOfToken;)
+ (LineSDKMessageShareAuthorizationStatus * _Nonnull)lackOfToken SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) LineSDKMessageShareAuthorizationStatus * _Nonnull lackOfFriendsPermission;)
+ (LineSDKMessageShareAuthorizationStatus * _Nonnull)lackOfFriendsPermission SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) LineSDKMessageShareAuthorizationStatus * _Nonnull lackOfGroupsPermission;)
+ (LineSDKMessageShareAuthorizationStatus * _Nonnull)lackOfGroupsPermission SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) LineSDKMessageShareAuthorizationStatus * _Nonnull lackOfMesasgeWritePermission;)
+ (LineSDKMessageShareAuthorizationStatus * _Nonnull)lackOfMesasgeWritePermission SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithRawValue:(NSInteger)rawValue OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSInteger, LineSDKMessageShareTargetType, closed) {
...
@property (nonatomic, strong) id <LineSDKShareViewControllerDelegate> _Nullable shareProxyDelegate;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
+ (NSArray<LineSDKMessageShareAuthorizationStatus *> * _Nonnull)localAuthorizationStatusForSendingMessage SWIFT_WARN_UNUSED_RESULT;
@end
...
typedef SWIFT_ENUM(NSInteger, LineSDKTemplateMessagePayloadImageAspectRatio, closed) {
...
typedef SWIFT_ENUM(NSInteger, LineSDKTemplateMessagePayloadImageContentMode, closed) {
