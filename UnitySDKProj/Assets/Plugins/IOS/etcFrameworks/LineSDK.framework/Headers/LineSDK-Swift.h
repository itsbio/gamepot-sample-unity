...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LineSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7LineSDK11LoginButton")
...
///     <code>LoginPermission.oneTimeShare</code>. Use <code>ShareViewController.localAuthorizationStatusForSendingMessage(to:)</code> to check
///     whether you have a valid token with the necessary permission. If you don’t have them, you shouldn’t create and
///     show the <code>ShareViewController</code>, but prompt your user to authorize your app with these permissions.
///   </li>
///   <li>
...
/// warning:
///
/// Although <code>ShareViewController</code> is marked as <code>open</code>, it’s not recommended to create a subclass for it. The class is
...
SWIFT_CLASS("_TtC7LineSDK19ShareViewController")
...
@interface ShareViewController (SWIFT_EXTENSION(LineSDK)) <UIAdaptivePresentationControllerDelegate>
